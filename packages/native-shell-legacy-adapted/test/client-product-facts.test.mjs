...
test('browser width preserves its default and clamps saved splits without corrupting the preference', async () => {
  ...
  assert.equal(browserDockWidth(undefined, 1200), 660)
  assert.equal(browserDockWidth(undefined, 1600), 680)
  assert.equal(browserDockWidth(900, 1600), 900)
  assert.equal(browserDockWidth(900, 1000), 626)
  ...
  for (const invalid of [undefined, NaN, Infinity, -1, 0]) assert.equal(browserDockWidth(invalid, 1200), 660)
