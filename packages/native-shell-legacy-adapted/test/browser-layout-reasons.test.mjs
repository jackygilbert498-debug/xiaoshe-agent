...
function fixture(t, options = {}) {
  ...
  const exported = {}
  const context = vm.createContext({ exports: exported, window, document,
  ...
  return { state, reads, bounds, requests, intervals, cleared, observers, listeners, subscriptions, props,
