...
const validPayloads: Readonly<Record<string, SessionFormatJsonValue>> = {
  'verification/result': { turn: 1, mutationCallId: 'write-1', verifierCallId: 'read-1', gate: 'test', status: 'passed' },
  'xiaoshe/task-generation': { version: 1, generation: 1, relation: 'new', triggerMessageId: 'user-1' },
  'xiaoshe/research-evidence': { version: 1, generation: 1, turn: 1, kind: 'body', callId: 'read-1' },
  'xiaoshe/obligation-state': { version: 1, generation: 1, turn: 1, kind: 'ordered-read', status: 'pending', primary: 'read', fallback: 'bash' },
...
describe('released event and payload inventory', () => {
  it('has an executable valid fixture for every frozen released-v0 event type', () => {
    ...
    expect(RELEASED_V0_EVENT_TYPES).toHaveLength(55)
