...
import { XIAOSHE_EVENT_TYPES } from './xiaoshe-events.ts'
...
export function restoreReleasedV3Artifact(artifact: SessionFormatArtifact, knownEventTypes: ReadonlySet<string>): SessionFormatArtifact {
  ...
  restoreReleasedV2Artifact({ ...artifact, header: { ...artifact.header, version: 2 }, events }, new Set([...knownEventTypes, ...XIAOSHE_EVENT_TYPES]), 3)
  return artifact
}
