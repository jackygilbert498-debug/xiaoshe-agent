...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  {
    ...
    methods: [
      ...
      {
        signature: 'async saveSelection(next: ModelSelection): Promise<boolean>',
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'register<const Namespace extends string, T>( ns: Namespace & SettingsNamespaceInput<Namespace>, schema: z<T>, options?: SettingsRegisterOptions<T>, ): RevisionedSettingsScope<T>',
...
export const EVENT_API: readonly EventApiEntry[] = [
  ...
  {
    name: 'system-prompt/finalized',
    mode: 'waterfall',
    signature: '\'system-prompt/finalized\'(this: Scoped<SystemPrompt>, assembly: PromptAssembly, context: AssembleContext, next: () => Promise<PromptAssembly>): Promise<PromptAssembly>',
    summary: 'Observe or reject the exact assembly returned to the agent after complete/suppression enforcement.',
    description: 'Observe or reject the exact assembly returned to the agent after complete/suppression enforcement.',
    parameters: [{ name: 'assembly', description: 'the final enforced assembly about to reach the agent.' }, { name: 'context', description: 'the caller\'s per-assembly context.' }],
  },
  {
    name: 'tools/change',
    mode: 'emit',
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'RevisionedSettingsScope',
    declaration: 'export interface RevisionedSettingsScope<T> extends SettingsScope<T> {\n    getSnapshot(): SettingsScopeSnapshot<T>;\n}',
  },
  {
  ...
  },
  {
    ...
    declaration: 'export interface SessionEventMap {\n    \'turn/start\': {\n        turn: number;\n    };\n    \'turn/end\': {\n        turn: number;\n        reason: TurnEndReason;\n    };\n    \'step/start\': {\n        turn: number;\n        step: number;\n    };\n    \'step/end\': {\n        turn: number;\n        step: number;\n    };\n    \'user/message\': UserMessage;\n    \'system/message\': {\n        turn: number;\n        step: number;\n        message: SystemMessage;\n    };\n    \'assistant/message\': {\n        turn: number;\n        step: number;\n        message: AssistantMessage;\n        stream: AssistantStreamRecord[];\n        usage?: TokenUsage;\n        interrupted?: true;\n    };\n    \'assistant/attempt\': {\n        turn: number;\n        step: number;\n        stream: AssistantStreamRecord[];\n    };\n    \'tool/call\': {\n        turn: number;\n        step: number;\n        callId: ToolCallId;\n        name: string;\n        arguments: string;\n    };\n    \'tool/result\': {\n        turn: number;\n        step: number;\n        message: ToolResultMessage;\n        error?: {\n            name: string;\n            code: string;\n        };\n        meta?: JsonValue;\n    };\n    \'verification/result\': {\n        turn: number;\n        mutationCallId: ToolCallId;\n        verifierCallId: ToolCallId;\n        gate: \'typecheck\' | \'test\' | \'build\' | \'browser\' | \'windows-evidence\' | \'migration-rollback\' | \'profile-dump\' | \'profile-start\' | \'functional-probe\' | \'release-confirmation\';\n        status: \'passed\' | \'failed\' | \'skipped\' | \'not-run\' | /* …truncated — full shape in source */',
  },
  {
  ...
  {
    name: 'SettingsScopeStatus',
    declaration: 'export type SettingsScopeStatus = \'ready\' | \'degraded\';',
  },
  {
