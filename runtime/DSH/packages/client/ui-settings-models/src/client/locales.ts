...
export const en = {
  ...
  knownProviderDescription: 'Connect a provider already supported by this Xiaoshe build. Nothing is selected automatically.',
  directProviderGroup: 'Direct model services',
  cloudProviderGroup: 'Cloud model platforms',
  gatewayProviderGroup: 'Gateways and aggregators',
  localProviderGroup: 'Local model runtimes',
  directProviderPurpose: 'Connects directly to this provider with an API key or its native authentication.',
  cloudProviderPurpose: 'Uses the cloud platform credential chain and region or project settings.',
  gatewayProviderPurpose: 'Routes several model families through one compatible gateway account.',
  localProviderPurpose: 'Connects to a model runtime on this computer or local network.',
  close: 'Close',
  cancel: 'Cancel',
  apply: 'Apply',
  applying: 'Applying…',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  add: '添加提供方',
  provider: '提供方',
  chooseProvider: '先选择一个模型服务商',
  knownProviderDescription: '连接当前小蛇版本已经支持的服务商；不会再自动替你选中第一项。',
  directProviderGroup: '模型官方服务',
  cloudProviderGroup: '云模型平台',
  gatewayProviderGroup: '模型网关与聚合服务',
  localProviderGroup: '本机模型运行环境',
  directProviderPurpose: '直接连接该模型服务，使用 API 密钥或服务商原生认证。',
  cloudProviderPurpose: '使用云平台的凭据链，以及区域或项目配置。',
  gatewayProviderPurpose: '通过一个兼容网关账户连接多个模型系列。',
  localProviderPurpose: '连接这台电脑或局域网中的本地模型服务。',
  close: '关闭',
  cancel: '取消',
  apply: '保存',
  applying: '保存中…',
