  ...
  ctx.effect(() => {
    const disposers = [
      ctx.locale.register(ACCESS_NS, 'zh', {
        'mode.readOnly': accessZh['mode.readOnly'],
        'mode.project': accessZh['mode.project'],
        'mode.autonomous': accessZh['mode.autonomous'],
      ...
      ctx.locale.register(ACCESS_NS, 'en', {
        'mode.readOnly': accessEn['mode.readOnly'],
        'mode.project': accessEn['mode.project'],
        'mode.autonomous': accessEn['mode.autonomous'],
