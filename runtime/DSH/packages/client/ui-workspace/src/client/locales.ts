...
export const zh = {
  ...
  'menu.moveSession': '移入项目',
  'move.session.title': '移入项目',
  'move.session.desc': '选择项目后，小蛇会保留当前对话历史，并将后续工作切换到该项目目录。',
  'move.session.empty': '还没有项目，请先使用“新建项目”按钮创建。',
  'move.session.pending': '正在迁移对话…',
...
export const en = {
  ...
  'menu.moveSession': 'Move to project',
  'move.session.title': 'Move to project',
  'move.session.desc': 'Xiaoshe keeps the conversation history and continues future work in the selected project folder.',
  'move.session.empty': 'No projects yet. Create one with the New Project button first.',
  'move.session.pending': 'Moving conversation…',
