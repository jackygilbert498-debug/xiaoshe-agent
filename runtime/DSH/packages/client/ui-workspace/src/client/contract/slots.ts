...
export type WorkspaceBrowserInjected = {
   ...
   * Workspace or clear into the New Session view and request the picker.
   */
  ...
  /** Preserve history while moving a loose conversation into a Workspace. */
  moveSessionToWorkspace?: (sessionId: SessionId, workspaceId: WorkspaceId) => Promise<void>
  /**
