 ...
 */
export function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onMove, drag, flat = false, t }: {
  node: SessionNode
  currentId: string | undefined
  now: number
  ...
  /** Available for loose conversations that can be assigned to a project. */
