...
describe('Modal', () => {
  ...
  it('traps focus, makes the background inert, and returns focus after close', () => {
    ...
    const { container, rerender } = render(
      <Modal open onClose={onClose} title="Accessible dialog" closeLabel="Close">
        <input aria-label="first field" />
        <button type="button">Last action</button>
      </Modal>)

    const field = screen.getByRole('textbox', { name: 'first field' })
    ...
    rerender(<Modal open={false} onClose={onClose} title="Accessible dialog" />)
