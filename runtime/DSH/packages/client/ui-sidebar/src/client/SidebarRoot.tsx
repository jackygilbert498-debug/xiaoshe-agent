...
import {
  FishLogo, IconNewChatOutline16, IconPanelLeftOutline16, IconProjectAddOutline16, Tooltip,
...
export function SidebarRoot({
  ...
  return (
    ...
    >
      ...
      <div className={css.newSessionRow}>
        ...
        {wide && createProject !== undefined && (
          <Tooltip label={t('project.new.label')} delayMs={500}>
            <button type="button" className={css.newProject} aria-label={t('project.new.label')} onClick={createProject}>
