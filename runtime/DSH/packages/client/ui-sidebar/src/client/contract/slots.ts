...
export type SidebarRootInjected = {
   ...
   * and open it; without one, inherit the current Session Workspace or clear
   * into the New Session view and request the Workspace picker.
   */
  startSession: (workspaceId?: WorkspaceId) => void
  /** Pick and register a directory as a new project, then open its first conversation. */
  createProject?: () => void
