...
export interface SessionsPort {
   ...
   */
  create(opts: { workspaceId?: WorkspaceId; loose?: boolean }): Promise<SessionId>
  /** Fork a completed conversation into another Workspace. */
  fork(opts: { sessionId: SessionId; workspaceId?: WorkspaceId; targetCwd?: string; increaseTitle?: boolean }): Promise<SessionId>
  /**
