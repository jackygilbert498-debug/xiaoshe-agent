...
function optionLabel(option: PermissionSelectValue['options'][number], t: ComposerBarProps['t']): string {
  ...
  if (option.value === 'workspace-write') return t('access.mode.approval')
  if (option.value === FULL_ACCESS) return t('access.mode.autonomous')
