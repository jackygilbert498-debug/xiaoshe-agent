...
export const zh = {
  ...
  'access.mode.readOnly': '只读观察',
  'access.mode.approval': '项目内执行',
  'access.mode.autonomous': '自主执行',
  ...
  'access.confirm.title': '确认启用自主执行？',
  'access.confirm.description': '自主执行拥有完整文件访问且不会逐项请求确认，可以直接修改项目外文件、执行命令和完成桌面操作。请只在你信任当前任务时使用。',
  'access.confirm.acknowledge': '我已了解风险，并愿意继续',
  'access.confirm.cancel': '取消',
  'access.confirm.enable': '启用自主执行',
...
export const en = {
  ...
  'access.mode.approval': 'Project access',
  'access.mode.autonomous': 'Autonomous',
  ...
  'access.confirm.title': 'Enable Autonomous execution?',
  'access.confirm.description': 'Autonomous execution has full file access and does not ask for approval step by step. It may change files outside the project, run commands, and operate the desktop. Use it only for trusted tasks.',
  'access.confirm.acknowledge': 'I understand the risks and want to continue',
  'access.confirm.cancel': 'Cancel',
  'access.confirm.enable': 'Enable Autonomous execution',
