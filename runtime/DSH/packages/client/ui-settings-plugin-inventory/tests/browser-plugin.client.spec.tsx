...
describe('ui-settings-plugin-inventory browser plugin', () => {
  ...
  it('registers a localized tab without reading the Remote eagerly', async () => {
    ...
    expect(resolveSlotLabel(entry.options.label)).toBe('已安装组件')
  ...
  it('follows locale and recovers across late declaration and declarer reload', async () => {
    ...
    expect(resolveSlotLabel(b.slots.entries('settings.plugins.tab')[0]!.options.label)).toBe('Installed components')
