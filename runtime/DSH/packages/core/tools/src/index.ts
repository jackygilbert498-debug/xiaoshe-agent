...
export interface ToolOutputDefinition {
  ...
  /**
   * Pure replayable presentation projection for direct and nested calls.
   * Nested projections are persisted on `tool/code-dispatch`; they must stay
   * bounded and omit secrets/raw result duplication just like top-level meta.
   */
...
export interface ToolResult {
   ...
   * and threaded verbatim from the durable result event. Absent when the tool
